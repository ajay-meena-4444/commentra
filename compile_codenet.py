...
# info-
#
# report_dir- /scratch/PLTranslation_data/reports
...
python3 /home/codetrans/codetlingua/compile_codenet.py --source_lang Python --target_lang Java --model starcoder --approach autocot2d
