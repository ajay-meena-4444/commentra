...
'''
# info-
# python3 /home/PLTranslationEmpirical/src/test/compile_avatar.py --source_lang Python --target_lang Java --model StarCoder --report_dir /scratch/PLTranslation_data/reports
# python3 /home/PLTranslationEmpirical/src/test/compile_avatar_feedback.py --source_lang Java --target_lang Python --model StarCoder --report_dir /scratch/PLTranslation_data/reports --attempt 2
#
