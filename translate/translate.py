...
-input/output locations 
    ...
    -full out loc
-log/print
python3 /home/codetrans/codetlingua/translate/translate.py --model=granite-20b-code-instruct --dataset=avatar --source_lang=Python --target_lang=Java --prompt_type=vanilla --temperature=0.2 --n_samples=10 --batch_size=10 --max_length=4090 --ngpus=2
...
#            # prompt+=code_data
#            code_id = p_name
#            common_path=f"/home/Project/dataset/{args.dataset}/{args.source_lang}/TestCases/"
